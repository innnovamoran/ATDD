...
import { FeatureStructure } from "./FeatureStructure";

@ObjectType({ description: "Pantalla características" })
export class Feature {
  ...
  @Field((type) => [FeatureStructure], {
    nullable: true,
    description: "Formulario de características",
  })
